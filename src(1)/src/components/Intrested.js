...
class Intrested extends Component {
  ...
  getData = () => {
    ...
    return new Promise((resolve, reject) => {
      axios.get(`http://127.0.0.1:8080/users/getInterestedProfile/${profileId}`).then(function (response) {
        resolve(response);
  ...
  accept=()=>{
    ...
    return new Promise((resolve, reject) => {
      axios.put(`http://127.0.0.1:8080/users/updateAcceptReject`,mat).then(function (response) {
        resolve(response);
